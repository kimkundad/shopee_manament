...
export default function useChats() {
  ...
  return (
      <Box m="10px" height={`calc(100vh - 137px)`}>
        ...
        <Grid templateColumns="repeat(5, 1fr)" m="20px" border="1px solid" borderColor="grey" borderRadius="xl" height={`calc(100vh - 228px)`}>
          <GridItem colSpan={1} >
            <Flex p="20px" borderBottom="1px solid grey">
              <Image
                borderRadius="50%"
                ...
                w="55px "
              />
              <Text fontSize="24px" fontWeight="bold" alignSelf="center" pl="10px">
                {users[0]?.name}
              </Text>
            </Flex>
            <Box>
          ...
          <GridItem colSpan={4} borderLeft="1px solid" borderColor="grey">
            <Box fontSize="24px">
              ...
              <Box height={`calc(100vh - 395px)`} overflow="auto" ref={chatBoxRef}>
