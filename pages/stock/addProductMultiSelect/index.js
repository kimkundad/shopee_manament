            ...
            <ModalContent>
              ...
              <ModalBody>
                <Box>
                  ...
                  <Input  id="price_option"/>
                  <Text>จำนวนสินค้า:</Text>
                  <Input id="stock"/>
                  <Text>รหัสสินค้า:</Text>
                  <Input id="sku"/>
                  <Button mt="10px" onClick={() => handleOption1()}>save</Button>
                </Box>
              </ModalBody>
