...
function index() {
  ...
  console.log(currentItems.length - 1);
  return (
    <Box w="100%">
          ...
          {currentItems?.map((item, index) => {
            return (
              ...
              >
                ...
                <Table.Cell>{item.nameproduct}</Table.Cell>
                <Table.Cell css={{ textAlign: "center" }}>
                  {item.productId}
                </Table.Cell>
                <Table.Cell css={{ textAlign: "center" }}>
                  {item.linkshop !== undefined ? (
                    <Flex justifyContent="center">
                      <Text>{item.linkshop}</Text>
                      <Image
                        src="/images/copy.png"
                        h="20px"
                        pl="10px"
                ...
                <Table.Cell css={{ textAlign: "center" }}>
                  <Link href="/report/detailCustomer">{item.customername}</Link>
                </Table.Cell>
                <Table.Cell css={{ textAlign: "center" }}>
                  {item.address}
                </Table.Cell>
